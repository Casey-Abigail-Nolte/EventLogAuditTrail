...
def connect_to_database():
    ...
    trusted_connection = config.DefaultConnection.get('Trusted_Connection', 'yes')
    ...
    cnxn = pyodbc.connect(f'DRIVER={{ODBC Driver 17 for SQL Server}};SERVER={server};DATABASE={database};Trusted_Connection={trusted_connection}')
    return cnxn
